...
Ctr01txt1  .oninput=()=>Ex01  .style.fontFamily =mapFont(Ctr01txt1.value)
Ctr01txt4  .oninput=()=>Ex01s2.style.fontFamily =mapFont(Ctr01txt4.value)
function mapFont(s){ //map appropriate fonts onto my base64 fonts
  switch (s.toLowerCase()) {
  case 'testfont'   : return 'tf'
  case 'dejavu sans': return 'dj'
  case 'freeserif'  : return 'fs'}
  return s }
