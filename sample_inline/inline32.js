...
Ctr01chk1.onclick = function () {
  return Ex01marker3.style.display = Ex01marker4.style.display = Ctr01chk1.checked ? 'unset' : 'none';
};
Ctr01chkIB.onclick = function () {
