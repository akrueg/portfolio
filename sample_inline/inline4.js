...
// example 2
Ctr02expand.onclick = function () {
  Ex02pane1.style.display = 'none';
  Ex02pane2.style.display = 'block';
};
Ctr02contract.onclick = function () {
  return Ex02pane1.style.display = Ex02pane2.style.display = '';
};
qsa('.Ex02tbl').forEach(function (tbl) {
  return tbl.querySelector('tbody').children[0].children[2].classList.add('beaver');
});
Ctr02rng.oninput = function () {
...
function setOffset(grad, arr, i) {
  grad.children[0].offset.baseVal = arr[i];
}
function setBars(i) {
  ...
  switch (i) {
    case 0:
      Ex02sTopBar.style.display = Ex02sMoveBar1.style.display = Ex02sImgBar1.style.display = 'inline-block';break;
    case 1:
      Ex02sImgBar3.style.display = 'inline-block';break;
    case 2:
      Ex02sMoveBar2.style.display = Ex02sImgBar3.style.display = 'inline-block';break;
    case 3:
      Ex02sImgBar3.style.display = 'inline-block';break;
    case 4:
      Ex02sImgBar2.style.display = 'inline-block';break;
    case 5:
      Ex02sMoveBar1.style.display = Ex02sImgBar1.style.display = 'inline-block';break;
    case 6:
      Ex02sImgBar3.style.display = 'inline-block';break;
    case 7:
      Ex02sBottomBar.style.display = Ex02sMoveBar2.style.display = Ex02sImgBar3.style.display = 'inline-block';break;}
}

Ctr02txt1.oninput = function () {
  setVA('baseline');setOffsets(3);setBars(3);setVA(Ctr02txt1.value);
};
